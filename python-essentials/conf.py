...
project = 'Python Essentials'
copyright = '2019, Galvanize Inc, K12 Inc'
author = 'DSDE Team'
...
exclude_patterns += ['slides','workflow-templates','cs-soln','screencasts']
